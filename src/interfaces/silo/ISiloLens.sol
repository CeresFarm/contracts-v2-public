...
import {ISilo, ISiloConfig} from "./ISilo.sol";

///////////////////////////////////////////////////////////////////////////////
// Flattened ISiloLens contract interface and dependencies
// Source: https://github.com/silo-finance/silo-contracts-v2/blob/develop/silo-core/contracts/interfaces/ISiloLens.sol
///////////////////////////////////////////////////////////////////////////////

// lib/silo-contracts-v2/silo-core/contracts/interfaces/IInterestRateModel.sol
...
// lib/silo-contracts-v2/silo-core/contracts/interfaces/IPartialLiquidation.sol
...
interface ISiloLens {
    ...
    function getFeesAndFeeReceivers(
        ISilo _silo
    ) external view returns (address daoFeeReceiver, address deployerFeeReceiver, uint256 daoFee, uint256 deployerFee);
    ...
    function collateralBalanceOfUnderlying(ISilo _silo, address _borrower) external view returns (uint256);
    ...
    function totalBorrowAmountWithInterest(ISilo _silo) external view returns (uint256 _totalBorrowAmount);
    ...
    function getDepositAmount(ISilo _silo, address _borrower) external view returns (uint256 borrowerDeposits);
    ...
    function getBorrowAmount(ISilo _silo, address _borrower) external view returns (uint256);
